    ...
    <form id="form1" runat="server">
        <header>
            <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
                ...
                <img src="images/logo.jpg" class="navbar-brand" alt="CSMS" height="60" width="60" />
        ...
        <footer id="foot" class="container-fluid card-body">
            ...
            <p class="mx-auto text-center">&copy;21IT027 21IT031 21IT159 &middot; <a href="#">Privacy</a> &middot; <a href="#">Terms</a></p>
        </footer>
